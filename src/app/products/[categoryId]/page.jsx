...
export default function Products() {
  ...
  useEffect(() => {
    fetchProducts(categoryId, initialPayload);
    getCategoryTypeById(categoryId);
  }, [categoryId, fetchProducts, getCategoryTypeById]);
  ...
  const handlePageChange = (page) => {
    setCurrentPage(page);
    setInitialPayload((prevPayload) => ({ ...prevPayload, page }));
    fetchProducts(categoryId, { ...initialPayload, page });
  };

  const handlePageSizeChange = (size) => {
    setPageSize(size);
    setCurrentPage(1);
    setInitialPayload((prevPayload) => ({ ...prevPayload, limit: size }));
  ...
  const handleFilterFieldsChange = (data) => {
    ...
    setCurrentPage(1);
    setInitialPayload((prevPayload) => ({ ...prevPayload, page: 1, filters: data }));
  ...
  return (
    <div className="flex mx-auto p-4 bg-white text-black">
      ...
      <div>
        ...
        <img 
          src={categoryType.category_image} 
          alt={categoryType.category_image} 
              ...
              return (
                <div 
                  ...
                  <div className="flex-1 mt-4 sm:mt-0 sm:ml-4 text-center sm:text-left">
                    ...
                    <p className="bg-gray-200 w-fit px-2 rounded-4xl mt-2 mx-auto sm:mx-0 text-center text-sm">{product.in_stock ? "In stock" : "Out of stock"}</p>
